      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple" style="float: right;">
            ...
            <el-button style="padding: 8px 20px;" @click="refreshwebstore()">搜  索</el-button>
          </div>
        </el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    created() {
      this.refreshwebstore()
    },
    methods: {
      //刷新店铺界面
      refreshwebstore(){
        var _this = this
        callApiForMbs('web_store/query_web_stores', {'pageSize': 10, 'pageNum': 1}, function (res) {
